...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  let g:terminal_ansi_colors = ['#414453', '#ff8170', '#78c2b3', '#d9c97c',
        \ '#4eb0cc', '#fc5fa3', '#b281eb', '#dfdfe0', '#7f8c98', '#ff8170',
        \ '#acf2e4', '#ffa14f', '#6bdfff', '#fc5fa3', '#dabaff', '#dfdfe0']
  if has('nvim')
    ...
    let g:terminal_color_13 = '#fc5fa3'
  ...
  hi MoreMsg guifg=#fc5fa3 guibg=NONE gui=NONE cterm=NONE
  hi Question guifg=#fc5fa3 guibg=NONE gui=NONE cterm=NONE
  ...
  hi Statement guifg=#fc5fa3 guibg=NONE gui=bold cterm=bold
  ...
  hi String guifg=#fc6a5d guibg=NONE gui=NONE cterm=NONE
